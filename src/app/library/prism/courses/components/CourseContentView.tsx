...
import { Pencil, Save, Loader2, Plus, BookOpen, Trash2 } from 'lucide-react';
            ...
            <div className="max-w-3xl mx-auto px-10 md:px-14 py-10 pb-24">
                ...
                <div className="mb-8 group/title">
                    {editingTitle ? (
                        ...
                        <div className="flex items-center gap-3">
                            <h1
                                className="text-2xl font-serif font-bold text-stone-800 cursor-pointer hover:text-stone-600 transition-colors"
