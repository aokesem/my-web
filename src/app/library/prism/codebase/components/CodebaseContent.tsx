...
export function CodebaseContent({ nodes, selectedPath, languageId, isLoading, onDataChange, editorRef }: CodebaseContentProps) {
    ...
    return (
        <div className="flex flex-col h-full bg-white relative">
            ...
            <div className="h-12 border-b border-stone-200/60 flex items-center px-6 shrink-0 bg-white/80 backdrop-blur top-0 z-10 sticky">
                ...
                <div className="ml-auto flex items-center gap-2">
                    {isEditing ? (
                        ...
                        <Button size="sm" variant="outline" className="h-7 text-xs text-stone-600 border-stone-200 px-3 hover:bg-stone-50 hover:text-purple-600" onClick={() => setIsEditing(true)}>
                            编辑内容
                        </Button>
                    )}
                </div>
            ...
            {/* Editor Area */}
            <div 
                className="flex-1 overflow-y-auto px-10 py-8 custom-scrollbar relative group"
